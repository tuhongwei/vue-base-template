<template>
  <div id="loading" class="lx-load-mark">
    <div class="lx-load-box">
      <div class="lx-loading">
        <div
          :class="['loading_leaf', 'loading_leaf_' + (n - 1)]"
          v-for="n in loadingLeafNum"
          :key="n"
        ></div>
      </div>
      <div class="lx-load-content">{{ loadingText }}</div>
    </div>
  </div>
</template>
